    ...
    render() {
      return (
        <View style={styles.mainViewStyle}>
          ...
          <Text style={styles.settingTextStyle}>- Cloud based PioSolver solution library for line checks</Text>

          <Text style={styles.settingTextStyle}>Please send all feedback and support queries to anthony@edenroselondon.co.uk</Text>

          <Text style={styles.settingTextStyle}>Privacy Policy: </Text>

          <Text style={styles.settingTextStyle}>https://www.edenroselondon.co.uk/poker-dex-privacy-policy</Text>
        </View>
      )
      }
    }
